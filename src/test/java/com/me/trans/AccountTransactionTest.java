...
public class AccountTransactionTest {
	...
	public void testCSVReadWithCorrectPath() throws IOException {
		...
		assertEquals(collectedTransaction.get(0).getTransactionId(), "TX10001");
	}

	@Test
	public void testCSVReadWithWrongPath() throws IOException {
		File csvFile = new File("resources/sample_data1.csv");
		assertThrows(FileNotFoundException.class, () -> TransactionUtility.fetchTransactionsFromCSVFile(csvFile));
	}
